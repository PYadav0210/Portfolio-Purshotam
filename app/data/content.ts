...
export const projects = [
  { title: "German Tech Job Market", badge: "Live Dashboard", desc: "A full data pipeline and live dashboard analyzing 870+ current German tech job postings. Python fetches and cleans data from the Arbeitnow API, extracts in-demand skills, and stores it in Supabase (PostgreSQL); a Next.js frontend renders it as interactive charts — top skills, jobs by city and remote share.", tags: ["Python", "Supabase", "PostgreSQL", "Next.js", "Recharts", "Data Pipeline"], href: "https://github.com/PYadav0210/job-market-dashboard", live: "https://job-market-dashboard-iota.vercel.app/", featured: true },
